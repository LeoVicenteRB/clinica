...
O painel real fica em `/admin/painel`, mas essa rota é protegida pelo servidor. Sem login, ela redireciona para a tela de login.
...
- O painel `/admin/painel` é protegido no backend.
